...
This repository contains R code and sample data for simulations and analyses related to the [**Robust Regression with Student's T: The Role of Degrees of Freedom**](https://arxiv.org/abs/2603.00269) paper. The main R functions have been packaged into an R package, available at: [RobustTRegression](https://github.com/amanda-ng518/RobustTRegression).
